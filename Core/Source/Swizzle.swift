...
internal func swizzleMethod(class_: AnyClass, selector1 sel1: String, selector2 sel2: String) {
...
public func ks_swizzleInstanceMethod(class_: AnyClass, sel1: String, sel2: String)
{
    swizzleMethod(class_, selector1: sel1, selector2: sel2)
}

public func ks_swizzleClassMethod(class_: AnyClass, sel1: String, sel2: String)
{
