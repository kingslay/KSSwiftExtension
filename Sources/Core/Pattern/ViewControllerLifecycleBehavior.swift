...
extension ViewControllerLifecycleBehavior {
    func afterLoading(_: UIViewController) {}

    func beforeAppearing(_: UIViewController) {}

    func afterAppearing(_: UIViewController) {}

    func beforeDisappearing(_: UIViewController) {}

    func afterDisappearing(_: UIViewController) {}

    func beforeLayingOutSubviews(_: UIViewController) {}

    func afterLayingOutSubviews(_: UIViewController) {}
}
